// api/scrape-bccc.js
// Border Communication Center (BCCC) specific scraping endpoint
...
export default async function handler(req, res) {
  ...
  try {
    const scrapeResult = await scrapeBorderCenter();
    
    // Publish to BCCC-specific channel
    ...
    console.error(`❌ BCCC scraping error:`, error);
...
async function scrapeBorderCenter() {
